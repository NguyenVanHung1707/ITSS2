    ...
    return (
        <div className='min-h-screen bg-slate-50'>
            ...
            <main className='container mx-auto px-4 py-8'>
                {/* Mobile Search Input (always visible on search page) */}
                <form onSubmit={handleSearch} className="block lg:hidden mb-4">
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-slate-200 bg-white shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                        />
                    </div>
                </form>
